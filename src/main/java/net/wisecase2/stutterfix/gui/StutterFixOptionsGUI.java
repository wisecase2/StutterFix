...
public class StutterFixOptionsGUI extends GameOptionsScreen {
    ...
    protected void init() {
        ...
        this.optionButtons.addSingleOptionEntry( new SimpleOption("stutterfix.options.worker_threads", SimpleOption.constantTooltip(Text.translatable("stutterfix.options.worker_threads.tooltip")), (optionText, value) -> {
        ...
        if(StutterFix.isInitializedRenderThread) {
            this.optionButtons.addSingleOptionEntry( new SimpleOption("stutterfix.options.render_thread_priority", SimpleOption.constantTooltip(Text.translatable("stutterfix.options.render_thread_priority.tooltip")), (optionText, value) -> {
        ...
        if(StutterFix.isInitializedServerThread) {
            this.optionButtons.addSingleOptionEntry( new SimpleOption("stutterfix.options.server_thread_priority", SimpleOption.constantTooltip(Text.translatable("stutterfix.server_thread_priority.tooltip")), (optionText, value) -> {
                return getGenericValueText(optionText, Text.translatable("stutterfix.options.thread_priority", new Object[]{value}));
